            ...
            <header className="d-flex justify-between align-center p-40">
                <Link to="">
                    <div className="headerLeft d-flex align-center">
                        <img width="40" height="40" src="img/logo.svg" alt="logo.svg"/>
                ...
                <ul className="headerRight d-flex ">
                    <li onClick={onCartClick} className="mr-30 cu-p">
                    ...
                    <li className="mr-30">
                        <Link to="favorites">
                            <svg className="cu-p" width="22" height="19" viewBox="0 0 22 19" fill="none" xmlns="http://www.w3.org/2000/svg">
